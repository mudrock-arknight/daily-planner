...
async function updateWeek13Plan() {
  ...
  try {
    const weeklyPlan = {
      ...
      data: {
        ...
        endDate: '2026-06-07',
        goals: [
          { id: '1', text: '工程力学阶段考准备', progress: 100, type: 'exam', deadline: '2026-06-02' },
          { id: '2', text: '毛概期末考试准备', progress: 50, type: 'exam', deadline: '2026-06-04' },
          { id: '3', text: '英语六级每日2h', progress: 3, totalHours: 100, type: 'study', deadline: '2026-06-13' },
          { id: '4', text: '车队工作汇报准备', progress: 30, type: 'task', deadline: '2026-06-05' },
          { id: '5', text: '科目四考试准备', progress: 0, type: 'task', deadline: '2026-06-07' }
        ],
        longTermGoals: [
          '雅思备考',
          'AI技术学习',
        ...
        dailySchedule: {
          ...
          '周三': {
            ...
            themeColor: 'purple',
            englishTarget: 2,
            focusGoal: '毛概期末考试冲刺复习',
            timeBlocks: [
              { time: '06:45-07:00', content: '起床、洗漱', type: 'break', detail: '早起复习' },
              { time: '07:00-07:30', content: '早餐', type: 'break', location: '食堂', detail: '营养早餐' },
              { time: '07:30-08:20', content: '英语听力训练', type: 'study', location: '车队', detail: '精听训练', countable: true },
              { time: '08:20-12:00', content: '毛概重点复习', type: 'study', location: '图书馆', detail: '背诵重点内容，集中复习', countable: true },
              { time: '12:00-12:40', content: '午餐', type: 'break', location: '食堂', detail: '规律饮食' },
              ...
              { time: '17:30-18:10', content: '晚餐', type: 'break', location: '食堂', detail: '晚餐时间' },
              { time: '18:10-22:00', content: '毛概冲刺复习', type: 'study', location: '图书馆', detail: '全面复习，准备明天考试', countable: true },
              { time: '22:00-22:45', content: '洗漱、准备睡觉', type: 'break', location: '宿舍', detail: '睡前放松，23:00前上床' }
            ]
          },
          '周四': {
            ...
            timeBlocks: [
              ...
              { time: '08:20-12:00', content: '毛概考前冲刺', type: 'study', location: '教室', detail: '快速回顾重点', countable: true },
              { time: '12:00-12:40', content: '午餐', type: 'break', location: '食堂', detail: '补充能量' },
              { time: '12:40-13:40', content: '午休', type: 'break', location: '宿舍', detail: '短暂休息' },
              { time: '13:40-17:30', content: '毛概考前准备', type: 'study', location: '图书馆', detail: '最后复习', countable: true },
              { time: '17:30-18:00', content: '晚餐', type: 'break', location: '食堂', detail: '简单晚餐' },
              { time: '18:00-19:30', content: '毛概期末考试', type: 'exam', location: '待通知', detail: '期末考试，18:00-19:30' },
              { time: '19:30-20:00', content: '考试后放松', type: 'break', detail: '稍作休息' },
              { time: '20:00-21:30', content: '车队汇报准备', type: 'task', location: '车队', detail: '准备明天汇报材料' },
              { time: '21:30-22:00', content: '练字', type: 'task', location: '宿舍', detail: '书法练习' },
              { time: '22:00-22:45', content: '洗漱、准备睡觉', type: 'break', location: '宿舍', detail: '睡前放松，23:00前上床' }
            ]
          },
          '周五': {
            ...
            timeBlocks: [
              ...
              { time: '08:20-10:00', content: '车队汇报准备', type: 'task', location: '车队', detail: '最后准备汇报材料' },
              { time: '10:00-10:25', content: '课间休息', type: 'break', detail: '活动放松' },
              { time: '10:25-12:00', content: '工程力学一', type: 'class', location: '日新楼南401', detail: '第3-4节合并' },
              { time: '12:00-12:40', content: '午餐', type: 'break', location: '食堂', detail: '规律饮食' },
              { time: '12:40-13:40', content: '午休', type: 'break', location: '宿舍', detail: '休息恢复' },
              { time: '13:40-14:00', content: '前往车队', type: 'break', detail: '准备组会' },
              { time: '14:00-17:00', content: '方程式车队组会汇报', type: 'task', location: '车队', detail: '项目进度汇报' },
              { time: '17:00-17:30', content: '汇报后讨论', type: 'break', detail: '交流讨论' },
              { time: '17:30-18:10', content: '晚餐', type: 'break', location: '食堂', detail: '晚餐时间' },
          ...
          '周六': {
            ...
            timeBlocks: [
              ...
              { time: '09:15-11:00', content: '科目四理论学习', type: 'study', location: '宿舍', detail: '题库练习' },
              { time: '11:00-12:00', content: 'AI技术学习', type: 'study', location: '图书馆', detail: '机器学习基础' },
              { time: '12:00-12:40', content: '午餐', type: 'break', location: '食堂', detail: '规律饮食' },
              { time: '12:40-13:40', content: '午休', type: 'break', location: '宿舍', detail: '休息恢复' },
              { time: '13:40-15:10', content: '科目四题库练习', type: 'study', location: '宿舍', detail: '模拟考试' },
          ...
          '周日': {
            ...
            timeBlocks: [
              ...
              { time: '09:00-09:15', content: '休息', type: 'break', detail: '活动一下' },
              { time: '09:15-10:45', content: '科目四复习', type: 'study', location: '宿舍', detail: '准备考试' },
        ...
        weeklyReview: {
          ...
          thisWeekFocus: '工程力学阶段考（已完成，6月2日）、毛概期末考试（6月4日18:00-19:30）、方程式车队组会汇报（6月5日）、英语六级每日2h、科目四考试准备（周末）。',
    ...
    console.log('\n⏰ 本周重要时间节点：')
    console.log('  ✅ 6月2日（周二）- 工程力学阶段考（已完成）')
    console.log('  ⚠️ 6月4日（周四）- 毛概期末考试（18:00-19:30）')
    console.log('  ⚠️ 6月5日（周五）- 方程式车队组会汇报')
    console.log('  ⚠️ 6月6日-7日（周末）- 科目四考试准备')
