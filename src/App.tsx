...
function Navbar() {
  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 bg-surface-card border-t border-border px-4 py-3 z-50">
          ...
          return (
            <Link
              ...
              className={`flex flex-col items-center gap-1 transition-all ${
                isActive ? 'text-primary-600' : 'text-ink-subtle hover:text-ink'
              }`}
            >
              <item.icon size={24} />
